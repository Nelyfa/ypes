...
print_color $BLUE "   🌐 Веб-интерфейс: http://localhost:8080"
print_color $BLUE "   🔗 API endpoint: http://localhost:8080/api/mirror"
print_color $BLUE "   ❤️  Health check: http://localhost:8080/health"
print_color $BLUE "   📦 Репозиторий: https://github.com/Nelyfa/ypes"
echo ""
