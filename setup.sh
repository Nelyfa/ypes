...
print_color $BLUE "   🌐 Веб-интерфейс: http://localhost:81"
print_color $BLUE "   🔗 API endpoint: http://localhost:81/api/mirror"
print_color $BLUE "   ❤️  Health check: http://localhost:81/health"
print_color $BLUE "   📦 Репозиторий: https://github.com/Nelyfa/ypes"
echo ""
